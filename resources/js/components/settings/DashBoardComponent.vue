<template>
    <div>
        ...
        <v-container fluid>
            <div>
                <v-row class="body-2">
                    <percent-monitored class></percent-monitored>
                    <v-spacer></v-spacer>
        ...
        <v-container fluid>
            <div>
                <v-row class="body-2 mt-8">
                    <v-col>
                        <crashed-channels></crashed-channels>
                    </v-col>
                    <v-col>
                        <v-spacer></v-spacer>
                        <current-crashed></current-crashed>
                    </v-col>
                    <v-col class="pr-12">
                        <v-spacer></v-spacer>
                ...
                <v-row class="body-2 mt-6">
                    <v-col>
                        <failedjobs-component></failedjobs-component>
                    </v-col>
                    <v-col>
                        <queue-component></queue-component>
                    </v-col>
                    <v-col>
                        <userslastchanges-component></userslastchanges-component>
                    </v-col>
                </v-row>
            </div>
        </v-container>
...
export default {
    data() {
        return {
            items: [
                { icon: "mdi-view-dashboard", title: "Přehled" },
                { title: "Přehled nefunkčních kanálů", icon: "mdi-television" },
                { title: "Přehled odeslaných Mailů", icon: "mdi-email" },
                { title: "Historie uživatelů", icon: "mdi-history" }
            ]
        };
    },
    components: {
        ...
        "failedjobs-component": FailedJobs,
        "userslastchanges-component": UsersLastChangesComponent,
